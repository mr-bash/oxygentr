        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="row">
            <div class="col-md-10">
              ...
              if($_SERVER['REQUEST_METHOD'] == 'POST' AND isset($_POST['add_services'])) {

                $ob_services = new services();

                $ob_services->get_input($_POST['title'], $_POST['content'], $_FILES['img_sec'], 'add', '');
              }
              ...
              ?>
                ...
                <div class="form-group">
                  <div class="col-sm-offset-3 col-sm-6">
                    <button type="submit" name="add_services" class="btn btn-block btn-success" style="margin:20px 0;">اضافة</button>
                  </div>
                </div>
            </form>
        </div>
